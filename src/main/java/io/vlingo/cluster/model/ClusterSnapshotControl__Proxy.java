...
public class ClusterSnapshotControl__Proxy extends ActorProxyBase<io.vlingo.cluster.model.ClusterSnapshotControl> implements io.vlingo.cluster.model.ClusterSnapshotControl {
  ...
  public ClusterSnapshotControl__Proxy(final Actor actor, final Mailbox mailbox){
    super(io.vlingo.cluster.model.ClusterSnapshotControl.class, SerializationProxy.from(actor.definition()), actor.address());
    this.actor = actor;
