...
public class OperationalOutboundStream__Proxy extends ActorProxyBase<io.vlingo.cluster.model.outbound.OperationalOutboundStream> implements io.vlingo.cluster.model.outbound.OperationalOutboundStream {
  ...
  public OperationalOutboundStream__Proxy(final Actor actor, final Mailbox mailbox){
    super(io.vlingo.cluster.model.outbound.OperationalOutboundStream.class, SerializationProxy.from(actor.definition()), actor.address());
    this.actor = actor;
  ...
  @Override
  public void split(io.vlingo.wire.node.Id arg0, io.vlingo.wire.node.Id arg1) {
    if (!actor.isStopped()) {
  ...
  @Override
  public void close(io.vlingo.wire.node.Id arg0) {
    if (!actor.isStopped()) {
      ActorProxyBase<OperationalOutboundStream> self = this;
  ...
  @Override
  public void directory(java.util.Set<io.vlingo.wire.node.Node> arg0) {
    if (!actor.isStopped()) {
      ActorProxyBase<OperationalOutboundStream> self = this;
  ...
  @Override
  public void open(io.vlingo.wire.node.Id arg0) {
    if (!actor.isStopped()) {
      ActorProxyBase<OperationalOutboundStream> self = this;
  ...
  @Override
  public void elect(java.util.Collection<io.vlingo.wire.node.Node> arg0) {
    if (!actor.isStopped()) {
      ActorProxyBase<OperationalOutboundStream> self = this;
  ...
  @Override
  public void ping(io.vlingo.wire.node.Id arg0) {
    if (!actor.isStopped()) {
      @SuppressWarnings("unused")
      ActorProxyBase<OperationalOutboundStream> self = this;
  ...
  @Override
  public void pulse(io.vlingo.wire.node.Id arg0) {
    if (!actor.isStopped()) {
      ActorProxyBase<OperationalOutboundStream> self = this;
  ...
  @Override
  public void vote(io.vlingo.wire.node.Id arg0) {
    if (!actor.isStopped()) {
      ActorProxyBase<OperationalOutboundStream> self = this;
  ...
  @Override
  public void leader(io.vlingo.wire.node.Id arg0) {
    if (!actor.isStopped()) {
      ActorProxyBase<OperationalOutboundStream> self = this;
  ...
  @Override
  public void application(io.vlingo.cluster.model.message.ApplicationSays arg0, java.util.Collection<io.vlingo.wire.node.Node> arg1) {
    if (!actor.isStopped()) {
      ActorProxyBase<OperationalOutboundStream> self = this;
