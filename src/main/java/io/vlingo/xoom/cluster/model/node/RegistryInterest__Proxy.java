...
public class RegistryInterest__Proxy extends ActorProxyBase<io.vlingo.xoom.cluster.model.node.RegistryInterest> implements io.vlingo.xoom.cluster.model.node.RegistryInterest {

  private static final String informMergedAllDirectoryEntriesRepresentation1 = "informMergedAllDirectoryEntries(java.util.Collection<io.vlingo.xoom.wire.node.Node>, java.util.Collection<io.vlingo.xoom.cluster.model.node.MergeResult>, boolean)";
  private static final String informCurrentLeaderRepresentation2 = "informCurrentLeader(io.vlingo.xoom.wire.node.Node, boolean)";
  private static final String informLeaderDemotedRepresentation3 = "informLeaderDemoted(io.vlingo.xoom.wire.node.Node, boolean)";
  private static final String informConfirmedByLeaderRepresentation4 = "informConfirmedByLeader(io.vlingo.xoom.wire.node.Node, boolean)";
  private static final String informNodeTimedOutRepresentation5 = "informNodeTimedOut(io.vlingo.xoom.wire.node.Node, boolean)";
  private static final String informAllLiveNodesRepresentation6 = "informAllLiveNodes(java.util.Collection<io.vlingo.xoom.wire.node.Node>, boolean)";
  private static final String informNodeIsHealthyRepresentation7 = "informNodeIsHealthy(io.vlingo.xoom.wire.node.Node, boolean)";
  private static final String informNodeJoinedClusterRepresentation8 = "informNodeJoinedCluster(io.vlingo.xoom.wire.node.Node, boolean)";
  private static final String informNodeLeftClusterRepresentation9 = "informNodeLeftCluster(io.vlingo.xoom.wire.node.Node, boolean)";

  private final Actor actor;
  private final Mailbox mailbox;

  public RegistryInterest__Proxy(final Actor actor, final Mailbox mailbox){
    super(io.vlingo.xoom.cluster.model.node.RegistryInterest.class, SerializationProxy.from(actor.definition()), actor.address());
    this.actor = actor;
  ...
  @Override
  public void informMergedAllDirectoryEntries(java.util.Collection<io.vlingo.xoom.wire.node.Node> arg0, java.util.Collection<io.vlingo.xoom.cluster.model.node.MergeResult> arg1, boolean arg2) {
    if (!actor.isStopped()) {
  ...
  @Override
  public void informCurrentLeader(io.vlingo.xoom.wire.node.Node arg0, boolean arg1) {
    if (!actor.isStopped()) {
      ActorProxyBase<RegistryInterest> self = this;
  ...
  @Override
  public void informLeaderDemoted(io.vlingo.xoom.wire.node.Node arg0, boolean arg1) {
    if (!actor.isStopped()) {
      ActorProxyBase<RegistryInterest> self = this;
  ...
  @Override
  public void informConfirmedByLeader(io.vlingo.xoom.wire.node.Node arg0, boolean arg1) {
    if (!actor.isStopped()) {
      ActorProxyBase<RegistryInterest> self = this;
  ...
  @Override
  public void informNodeTimedOut(io.vlingo.xoom.wire.node.Node arg0, boolean arg1) {
    if (!actor.isStopped()) {
      ActorProxyBase<RegistryInterest> self = this;
  ...
  @Override
  public void informNodeIsHealthy(io.vlingo.xoom.wire.node.Node arg0, boolean arg1) {
    if (!actor.isStopped()) {
      ActorProxyBase<RegistryInterest> self = this;
  ...
  @Override
  public void informNodeJoinedCluster(io.vlingo.xoom.wire.node.Node arg0, boolean arg1) {
    if (!actor.isStopped()) {
      ActorProxyBase<RegistryInterest> self = this;
  ...
  @Override
  public void informNodeLeftCluster(io.vlingo.xoom.wire.node.Node arg0, boolean arg1) {
    if (!actor.isStopped()) {
      ActorProxyBase<RegistryInterest> self = this;
