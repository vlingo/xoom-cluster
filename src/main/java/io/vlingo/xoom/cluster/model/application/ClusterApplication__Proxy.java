...
public class ClusterApplication__Proxy extends ActorProxyBase<io.vlingo.xoom.cluster.model.application.ClusterApplication> implements io.vlingo.xoom.cluster.model.application.ClusterApplication {

  private static final String handleApplicationMessageRepresentation1 = "handleApplicationMessage(io.vlingo.xoom.wire.message.RawMessage)";
  private static final String informResponderRepresentation2 = "informResponder(io.vlingo.xoom.wire.fdx.outbound.ApplicationOutboundStream)";
  private static final String informAllLiveNodesRepresentation3 = "informAllLiveNodes(java.util.Collection<io.vlingo.xoom.wire.node.Node>, boolean)";
  private static final String informLeaderElectedRepresentation4 = "informLeaderElected(io.vlingo.xoom.wire.node.Id, boolean, boolean)";
  private static final String informLeaderLostRepresentation5 = "informLeaderLost(io.vlingo.xoom.wire.node.Id, boolean)";
  private static final String informLocalNodeShutDownRepresentation6 = "informLocalNodeShutDown(io.vlingo.xoom.wire.node.Id)";
  private static final String informLocalNodeStartedRepresentation7 = "informLocalNodeStarted(io.vlingo.xoom.wire.node.Id)";
  private static final String informNodeIsHealthyRepresentation8 = "informNodeIsHealthy(io.vlingo.xoom.wire.node.Id, boolean)";
  private static final String informNodeJoinedClusterRepresentation9 = "informNodeJoinedCluster(io.vlingo.xoom.wire.node.Id, boolean)";
  private static final String informNodeLeftClusterRepresentation10 = "informNodeLeftCluster(io.vlingo.xoom.wire.node.Id, boolean)";
  ...
  private static final String informAttributesClientRepresentation13 = "informAttributesClient(io.vlingo.xoom.cluster.model.attribute.AttributesProtocol)";
  ...
  public ClusterApplication__Proxy(final Actor actor, final Mailbox mailbox){
    super(io.vlingo.xoom.cluster.model.application.ClusterApplication.class, SerializationProxy.from(actor.definition()), actor.address());
    this.actor = actor;
  ...
  @Override
  public void handleApplicationMessage(io.vlingo.xoom.wire.message.RawMessage arg0) {
    if (!actor.isStopped()) {
  ...
  @Override
  public void informResponder(io.vlingo.xoom.wire.fdx.outbound.ApplicationOutboundStream arg0) {
    if (!actor.isStopped()) {
      ActorProxyBase<ClusterApplication> self = this;
  ...
  @Override
  public void informAllLiveNodes(java.util.Collection<io.vlingo.xoom.wire.node.Node> arg0, boolean arg1) {
    if (!actor.isStopped()) {
      ActorProxyBase<ClusterApplication> self = this;
  ...
  @Override
  public void informLeaderElected(io.vlingo.xoom.wire.node.Id arg0, boolean arg1, boolean arg2) {
    if (!actor.isStopped()) {
      ActorProxyBase<ClusterApplication> self = this;
  ...
  @Override
  public void informLeaderLost(io.vlingo.xoom.wire.node.Id arg0, boolean arg1) {
    if (!actor.isStopped()) {
      ActorProxyBase<ClusterApplication> self = this;
  ...
  @Override
  public void informLocalNodeShutDown(io.vlingo.xoom.wire.node.Id arg0) {
    if (!actor.isStopped()) {
      ActorProxyBase<ClusterApplication> self = this;
  ...
  @Override
  public void informLocalNodeStarted(io.vlingo.xoom.wire.node.Id arg0) {
    if (!actor.isStopped()) {
      ActorProxyBase<ClusterApplication> self = this;
  ...
  @Override
  public void informNodeJoinedCluster(io.vlingo.xoom.wire.node.Id arg0, boolean arg1) {
    if (!actor.isStopped()) {
      ActorProxyBase<ClusterApplication> self = this;
  ...
  @Override
  public void informNodeLeftCluster(io.vlingo.xoom.wire.node.Id arg0, boolean arg1) {
    if (!actor.isStopped()) {
      ActorProxyBase<ClusterApplication> self = this;
  ...
  @Override
  public void informAttributesClient(io.vlingo.xoom.cluster.model.attribute.AttributesProtocol arg0) {
    if (!actor.isStopped()) {
      ActorProxyBase<ClusterApplication> self = this;
